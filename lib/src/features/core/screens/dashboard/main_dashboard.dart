...
import 'package:login_flutter_app/src/features/core/screens/workout_questions/location_selection_screen.dart';
...
class _MainDashboardScreenState extends State<MainDashboardScreen> {
  ...
  // double calculateDeficietCalories() {
  //   double deficietCalories = 0;
  ...
  //       break;
  //     case 'WeightGoal.mildWeightLoss':
  //       deficietCalories = 250;
  //       break;
  //     case 'WeightGoal.weightLoss':
  //       deficietCalories = 500;
  //       break;
  //     case 'WeightGoal.extremeWeightLoss':
  //       deficietCalories = 1000;
  //       break;
  //     case 'WeightGoal.mildWeightGain':
  //       deficietCalories = 250;
  //       break;
      ...
      floatingActionButton: SpeedDial(
        ...
        children: [
          SpeedDialChild(
            ...
            onTap: () => _showSignUpDialog(context, 'Generate Meal Plan'),
            shape: CircleBorder(),
            child: Icon(
          ...
          SpeedDialChild(
            label: 'Workout Plan',
            backgroundColor: Colors.white,
            onTap: () => _showSignUpDialog(context, 'Generate Workout Plan'),
            shape: CircleBorder(),
            child: Icon(
